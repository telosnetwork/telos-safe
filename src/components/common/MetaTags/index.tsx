...
const descriptionText = 'Telos Safe is the most trusted platform to manage digital assets on Telos.'
const titleText = 'Telos Safe'
...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    {/* Social sharing */}
    <meta name="og:image" content="https://safe.telos.net//images/social-share.png" />
    ...
    <meta name="twitter:image" content="https://safe.telos.net//images/social-share.png" />
