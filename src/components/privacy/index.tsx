  ...
  return (
    <div>
      ...
      <ol start={1}>
        ...
        <li>
          &ldquo;{'Telos Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
      ...
      <h4>4.1. When visiting our website and using {'Telos Safe'}</h4>
      <p>
        When visiting our website or using {'Telos Safe'}, we may collect and process personal data. The data will be
      ...
      <ol start={4} className={css.alphaList}>
        <li>
          ...
          the {'Telos Safe'}, we process your
          <ol start={1} className={css.romanList}>
      ...
      <p>
        In addition, we may take a recording of you while testing {'Telos Safe'} for internal and external use. The
      ...
      <p>
        {'Telos Safe'} mobile apps are distributed via{' '}
      ...
      <p>
        We enable the user to unlock the {'Telos Safe'} mobile app via biometrics information (touch ID or face ID).
